    ...
    <div class="relative z-10 w-full max-w-md bg-white dark:bg-slate-900 shadow-2xl border border-gray-100 dark:border-slate-800 rounded-xl overflow-hidden my-8 transition-colors">
        ...
        <div class="p-6 sm:p-8">
            <div class="mb-6 text-center">
                <h1 class="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Selamat Datang</h1>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Masuk dengan Nomor KTP atau Alamat Email Perusahaan Anda.</p>
            </div>
            ...
            <form wire:submit.prevent="login" class="space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1">
                        ...
                        <a href="#" class="text-[11px] text-blue-600 dark:text-blue-400 hover:text-blue-800 transition">Lupa password?</a>
                    </div>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400 dark:text-slate-500">
